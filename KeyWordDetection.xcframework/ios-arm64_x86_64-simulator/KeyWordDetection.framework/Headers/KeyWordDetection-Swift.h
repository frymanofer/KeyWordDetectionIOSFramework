...
@protocol PhraseSpotRNDelegate;

SWIFT_CLASS("_TtC16KeyWordDetection17KeyWordsDetection")
@interface KeyWordsDetection : NSObject
@property (nonatomic, weak) id <PhraseSpotRNDelegate> _Nullable delegate;
...
SWIFT_PROTOCOL("_TtP16KeyWordDetection20PhraseSpotRNDelegate_")
@protocol PhraseSpotRNDelegate
- (void)phraseSpotDidDetectEvent:(NSDictionary<NSString *, id> * _Nonnull)eventInfo;
@end
